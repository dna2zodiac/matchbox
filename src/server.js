...
const i_env = {
   ...
   server: {
      host: process.env.MATCHBOX_HOST || '127.0.0.1',
      port: parseInt(process.env.MATCHBOX_PORT || '8080'),
      staticDir: process.env.MATCHBOX_STATIC_DIR?i_path.resolve(process.env.MATCHBOX_STATIC_DIR):null,
      httpsCADir: process.env.MATCHBOX_HTTPS_CA_DIR?i_path.resolve(process.env.MATCHBOX_HTTPS_CA_DIR):null,
   },
};
